/** The five acts of the Annals, in chronicle order. */
import type { Act, ActId } from "./types";
...
export const ACTS_BY_ID: Record<ActId, Act> = Object.fromEntries(
  ACTS.map((act) => [act.id, act]),
) as Record<ActId, Act>;

export const actOf = (id: ActId): Act => ACTS_BY_ID[id];
