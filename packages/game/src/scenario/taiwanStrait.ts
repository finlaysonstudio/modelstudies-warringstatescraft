...
/**
 * Taiwan Strait 2027 — six turns, one decision point.
 * Extended from the two-move structure of Lamparth et al. 2024
 * (github.com/ancorso/LLMWargaming, MIT) into a multi-turn campaign.
 * Scenario is data: engine code contains nothing Taiwan-specific.
 */
