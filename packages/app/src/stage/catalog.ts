...
export const ARCHETYPE_SPRITES: Record<StageArchetype, string[]> = {
  envoy: ["sprite.official", "sprite.envoy"],
  general: ["sprite.knight", "sprite.general"],
  infantry: ["sprite.soldier", "sprite.infantry"],
  crossbowman: ["sprite.knight", "sprite.crossbowman"],
  cavalry: ["sprite.horse", "sprite.cavalry"],
  chariot: ["sprite.chariot"],
  merchant: ["sprite.merchant", "sprite.merchant"],
  peasant: ["sprite.peasant-red", "sprite.peasant"],
  clerk: ["sprite.clerk", "sprite.clerk"],
  scholar: ["sprite.sage", "sprite.scholar"],
  mohist: ["sprite.monk", "sprite.mohist"],
  assassin: ["sprite.bravo", "sprite.assassin"],
  hostage: ["sprite.prince-blue", "sprite.hostage"],
  labourer: ["sprite.labourer", "sprite.labourer"],
  court: ["sprite.king-gold", "sprite.court"],
  boat: ["sprite.boat"],
};
