...
npm run cli -- values-scorecard --plan crisis-situated              # topic shares per model -> var/scorecards/values-<plan>.json; /values renders it
